...
namespace GenericRepository.MSSQL
{
    public interface IGenericRepository<TEntity> where TEntity : class
    {
        ...
        public Task<(IEnumerable<TEntity>, bool, string)> GetPagingAsync(string[]? searchParams, string[]? searchValues, string? sortField = null, int? pageSize = 5, int? skip = 1, string? includeProperties = null);
        /// <summary>
